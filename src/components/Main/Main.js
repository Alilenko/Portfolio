    ...
    return (
        <div className='main'>
            ...
            <h1 className='about_name'>Алина Павленко</h1>
                ...
                <div className='about_location'><i className="fas fa-map-marker-alt"></i>Киев</div>
                <div className='about_phone'><a  href='tel:+380958413742'><i className="fas fa-phone-alt"></i> +38(095)841-37-42</a></div>
                <div className='about_mail' ><i className="far fa-envelope"></i>pavlenkoalina9694@gmail.com</div>
                <div className='about_social'>
                    <a href='https://github.com/Alilenko' className='about_link'><i className="fab fa-github"></i></a>
